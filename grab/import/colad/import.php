...
$row = sqlsrv_fetch_object(sqlsrv_query($conn, "SELECT TOP 1 * FROM abisingen.dbo.import
  WHERE LastScanDateTime IS NULL AND (url LIKE 'https://www.colad.co/nl_nl/%' OR url LIKE 'https://www.hamach.com/nl_nl/%'  OR url LIKE 'https://www.ronintools.com/nl_nl/%' )
  ORDER BY url;"));
if ($row->id) {
